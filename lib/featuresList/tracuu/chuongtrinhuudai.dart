...
class chuongtrinhuudai extends StatefulWidget {
  const chuongtrinhuudai({Key? key}) : super(key: key);

  @override
  State<chuongtrinhuudai> createState() => _chuongtrinhuudaiState();
}

class _chuongtrinhuudaiState extends State<chuongtrinhuudai> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(appBar: AppBar(
      title: const Text('Tra cứu chương trình ưu đãi'),
