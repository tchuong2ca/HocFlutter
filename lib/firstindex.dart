  ...
  Widget build(BuildContext context) {
    return  Scaffold(appBar: AppBar(
      ...
      body: Column(
        ...
        children:[Image.asset('images/pic3.jpg'),
          ...
          Container(
            ...
            child:  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
              ...
              children: [
                ...
                Column(children: [
                  IconButton(
                    icon: const Icon(Icons.add_alert),iconSize: 40,
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: GridView.count(
                        ...
                        children: List.generate(_features.length, (index) {
                          return Center(
                            child: features1(features: _features[index]),
                          );
                        })
                    ),
                  ),
                  ...
                  SizedBox(
                    ...
                    child: GridView.count(
                        ...
                        children: List.generate(_features.length, (index) {
                          return Center(
                            child: features2(features: _features[index], context: context),
                          );
                        })
                    ),
                  ),
        ...
        children: [
          Container(
            ...
            child: ClipRRect(
              ...
              child: Image.network(features.image),
            ),
          ),
          Text(features.name)],));
}
